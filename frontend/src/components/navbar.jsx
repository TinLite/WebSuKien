            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li>
                            <NavLink className="nav-link" to="#">Danh sách sự kiện</NavLink>
                        </li>
                        <li>
                            <NavLink className="nav-link" to="#">Sự kiện tôi đã tham gia</NavLink>
                        </li>
                        <li>
                    ...
                    {user ?
                        <div style={{
                            ...
                            <button className="btn btn-link" onClick={logoutHandler}>Đăng xuất</button> 
                        </div> :
